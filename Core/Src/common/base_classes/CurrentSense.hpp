 ...
 *  Ported from: https://github.com/simplefoc/Arduino-FOC/blob/v2.1/src/common/base_classes/CurrentSense.h
 */

#ifndef CURRENTSENSE_HPP_
#define CURRENTSENSE_HPP_
...
class CurrentSense{
     ...
     *   This function will be used with the foc control throughout the function
