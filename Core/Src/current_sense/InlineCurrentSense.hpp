 ...
 *  Ported from: https://github.com/simplefoc/Arduino-FOC/blob/v2.1/src/current_sense/InlineCurrentSense.h
 */

#ifndef INLINECURRENTSENSE_HPP_
#define INLINECURRENTSENSE_HPP_
